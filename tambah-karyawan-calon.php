...
<div class="container-fluid">
        ...
        <div class="row">
            <div class="col-lg-12">
                <ol class="breadcrumb">
                    ...
                    <li><i class="fa fa-laptop"></i>Isi Data Calon Karyawan</li>                          
                </ol>
            </div>
        </div>

        <div class="page-title">
            <span class="title">Isi Data Calon Karyawan</span>
                    ...
                    <div class="card-body">
                        <div class="step">
                            <ul class="nav nav-tabs nav-justified" role="tablist">
                                <li class="step-pelamar <?php if ( isset( $_GET['p'] ) == 'tambah-calon-karyawan' AND $param_pelamar == 'data-calon-karyawan' ) echo 'active'; ?>">
                                ...
                                <li class="step-pelamar <?php if ( isset( $_GET['p'] ) == 'tambah-calon-karyawan' AND $param_pelamar == 'berkas-lamaran' AND isset( $_GET['keycode'] ) ) echo 'active'; ?>">
                                    <!-- <a href="./?p=tambah-calon-karyawan&step=berkas-lamaran"> -->
                                ...
                                <li class="step-pelamar <?php if ( isset( $_GET['p'] ) == 'tambah-calon-karyawan' AND $param_pelamar == 'pertanyaan-calon-karyawan' ) echo 'active'; ?>">
                                    <!-- <a href="./?p=tambah-calon-karyawan&step=pertanyaan-calon-karyawan"> -->
                            ...
                            <div class="tab-content">
                                ...
                                <?php if ( isset( $_GET['p'] ) == 'tambah-calon-karyawan' AND $param_pelamar == 'data-calon-karyawan' ) { ?>
                                                ...
                                                <div class="card" style="box-shadow: none;">
                                                    ...
                                                    <!--     <div class="form-group ">
                                                            ...
                                                            <div class="col-lg-10">
                                                                ...
                                                                <input type="hidden" name="kategori_jabatan" value="2">
                                                            </div>
                                                        </div> -->
                                                        <input type="hidden" name="key_form" value="2"> <!-- form karyawan -->
                                                       ...
                                                       <!-- <div class="form-group ">
                                                            ...
                                                            <div class="col-lg-10">
                                                                <?php
                                                                // $query = $sdm->query( "SELECT * FROM master_unit WHERE status = '1' AND kategori_pegawai = '2'" );
 ...
 -->
                                ...
                                <?php } elseif ( isset( $_GET['p'] ) == 'tambah-calon-karyawan' AND $param_pelamar == 'berkas-lamaran' AND isset( $_GET['keycode'] ) ) { ?>
                                        ...
                                        <div class="tab-pane fade in active">
                                            ...
                                            <div class="form-group pull-right">
                                                <div class="col-lg-12">
                                                    ...
                                                    <button type="submit" name="next-step-from-berkas-karyawan" class="btn btn-info">Selanjutnya ></button>
                                                </div>
                                            </div>
                                        </div>
                                    </form>

                                <?php } elseif ( isset( $_GET['p'] ) == 'tambah-calon-karyawan' AND $param_pelamar == 'pertanyaan-calon-karyawan' AND isset( $_GET['keycode'] ) ) { ?>
                                    ...
                                    <form name="myForm" action="action-insert.php" method="post" class="form-horizontal form-label-left" id="form-questions">
                                            ...
                                            <div class="col-xs-12 no-padding question-crew">
                                                <div class="card" style="box-shadow: none;">
                                                    ...
                                                    <div class="card-body" style="padding-left: 0; padding-right: 0;">
                                                        ...
                                                        <?php 
                                                        if ( empty( $_SESSION['success_input_berkas_karyawan'] ) ) :
                                                            if ( !empty( $_SESSION['admin_id_recruitment'] ) ) {
                                                                 echo "<meta http-equiv='refresh' content='0; url=./'>"; 
                                                            }
                                                        endif;
                                                        ...
                                                        echo '<input type="hidden" name="keycode" value='.base64_encode( $normal_keycode.'pertanyaan-kw' ).'>';

                                                        $data_soal = $sdm->query( "SELECT * FROM master_soal WHERE kategori_pegawai = 'karyawan'" );
                                                        ...
                                                        ?>
                                                            <div class="form-group">
                                                                <div class="col-xs-12">
                                                                    ...
                                                                    <textarea name="jawaban[]" class="form-control ckeditor" rows="3"></textarea>
                                                                </div>
                                                            </div>
                                                        <?php $no++; } ?>
                                        ...
                                        <div class="form-group pull-right">
                                            <div class="col-lg-12">
                                                ...
                                                <button type="submit" name="finish-step-from-question-crew" class="btn btn-info">Finish</button>
                                            </div>
                                        </div>
                                    </form>
                                ...
                                <?php } else {
                                    ...
                                    echo "<meta http-equiv='refresh' content='0; url=./?p=tambah-calon-karyawan&step=data-calon-karyawan'>"; 
                                } 
                                ?>
                            </div>
                        </div> <!-- end: step -->
