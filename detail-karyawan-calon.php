        ...
        <div class="row">
            <div class="col-lg-12">
                <ol class="breadcrumb">
                    ...
                    <li><i class="fa fa-laptop"></i>Detail Calon Karyawan</li>                          
                </ol>
            </div>
        </div>

        <div class="page-title">
            <span class="title">Detail Calon Karyawan</span>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        ...
                                        <h4 class="modal-title">Edit Data Pribadi Calon Karyawan</h4>
                                    </div>
                                        ...
                                        <form role="form" method="post" action="action-update.php?id=<?php echo base64_encode( $data['id_calon_karyawan'] ); ?>" class="form-horizontal form-label-left popup-edit-crew">
                                            ...
                                            <!-- <div class="form-group">
                                                <div class="col-lg-12" style="margin-bottom: 15px;">
                                                    <label>Jabatan</label>
                                                    <input type="text" name="jabatan" class="form-control" id="jabatan<?php // echo $data['id_calon_karyawan']; ?>" value="<?php // echo $data['jabatan']; ?>">
                                                </div>
                                            </div> -->
                                        ...
                                        <form role="form" method="post" action="action-update.php?id=<?php echo base64_encode( $data['id_calon_karyawan'] ); ?>" class="form-horizontal form-label-left popup-edit-crew">
                                            ...
                                            <div class="form-group">
                                                <div class="col-lg-6" style="margin-bottom: 15px;">
                                                    ...
                                                    // }
                                                   ?>
                                                    <input type="text" name="riwayat_pekerjaan_mulai1" class="form-control datepicker" id="riwayat_pekerjaan_mulai1<?php echo $data['id_calon_karyawan']; ?>" value="<?php echo $data['riwayat_pekerjaan_mulai1']; ?>">
                                                </div>
                                                <div class="col-lg-6" style="margin-bottom: 15px;">
                                                    <label>Tanggal / Tahun Keluar</label>
                                                    <?php
                                                    ...
                                                    // }
                                                   ?>
                                                    <input type="text" name="riwayat_pekerjaan_akhir1" class="form-control datepicker" id="riwayat_pekerjaan_akhir1<?php echo $data['id_calon_karyawan']; ?>" value="<?php echo $data['riwayat_pekerjaan_akhir1']; ?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <div class="col-lg-6" style="margin-bottom: 15px;">
                                                    ...
                                                    // }
                                                   ?>
                                                    <input type="text" name="riwayat_pekerjaan_mulai2" class="form-control datepicker" id="riwayat_pekerjaan_mulai2<?php echo $data['id_calon_karyawan']; ?>" value="<?php echo $data['riwayat_pekerjaan_mulai2']; ?>">
                                                </div>
                                                <div class="col-lg-6" style="margin-bottom: 15px;">
                                                    <label>Tanggal / Tahun Keluar</label>
                                                    <?php
                                                    ...
                                                    // }
                                                   ?>
                                                    <input type="text" name="riwayat_pekerjaan_akhir2" class="form-control datepicker" id="riwayat_pekerjaan_akhir2<?php echo $data['id_calon_karyawan']; ?>" value="<?php echo $data['riwayat_pekerjaan_akhir2']; ?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <div class="col-lg-6" style="margin-bottom: 15px;">
                                                    ...
                                                    // }
                                                   ?>
                                                    <input type="text" name="riwayat_pekerjaan_mulai3" class="form-control datepicker" id="riwayat_pekerjaan_mulai3<?php echo $data['id_calon_karyawan']; ?>" value="<?php echo $data['riwayat_pekerjaan_mulai3']; ?>">
                                                </div>
                                                <div class="col-lg-6" style="margin-bottom: 15px;">
                                                    <label>Tanggal / Tahun Keluar</label>
                                                    <?php
                                                    ...
                                                    // }
                                                   ?>
                                                    <input type="text" name="riwayat_pekerjaan_akhir3" class="form-control datepicker" id="riwayat_pekerjaan_akhir3<?php echo $data['id_calon_karyawan']; ?>" value="<?php echo $data['riwayat_pekerjaan_akhir3']; ?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <div class="col-lg-6" style="margin-bottom: 15px;">
                                                    ...
                                                    // }
                                                   ?>
                                                    <input type="text" name="riwayat_pekerjaan_mulai4" class="form-control datepicker" id="riwayat_pekerjaan_mulai4<?php echo $data['id_calon_karyawan']; ?>" value="<?php echo $data['riwayat_pekerjaan_mulai4']; ?>">
                                                </div>
                                                <div class="col-lg-6" style="margin-bottom: 15px;">
                                                    <label>Tanggal / Tahun Keluar</label>
                                                    <?php
                                                    ...
                                                    // }
                                                   ?>
                                                    <input type="text" name="riwayat_pekerjaan_akhir4" class="form-control datepicker" id="riwayat_pekerjaan_akhir4<?php echo $data['id_calon_karyawan']; ?>" value="<?php echo $data['riwayat_pekerjaan_akhir4']; ?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <div class="col-lg-6" style="margin-bottom: 15px;">
                                                    ...
                                                    // }
                                                   ?>
                                                    <input type="text" name="riwayat_pekerjaan_mulai5" class="form-control datepicker" id="riwayat_pekerjaan_mulai5<?php echo $data['id_calon_karyawan']; ?>" value="<?php echo $data['riwayat_pekerjaan_mulai5']; ?>">
                                                </div>
                                                <div class="col-lg-6" style="margin-bottom: 15px;">
                                                    <label>Tanggal / Tahun Keluar</label>
                                                    <?php
                                                    ...
                                                    // }
                                                   ?>
                                                    <input type="text" name="riwayat_pekerjaan_akhir5" class="form-control datepicker" id="riwayat_pekerjaan_akhir5<?php echo $data['id_calon_karyawan']; ?>" value="<?php echo $data['riwayat_pekerjaan_akhir5']; ?>">
                                                </div>
                                            </div>
                        ...
                        <div aria-hidden="true" aria-labelledby="myModalBerkasPelamarLabel<?php echo $data_soal['id_soal_pelamar'].$no; ?>" role="dialog" tabindex="-1" id="myModalBerkasPelamar<?php echo $data_soal['id_soal_pelamar'].$no; ?>" class="modal fade">
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <button aria-hidden="true" data-dismiss="modal" class="close" type="button">×</button>
                                        <h4 class="modal-title">Edit Kelengkapan Berkas Calon Karyawan</h4>
                                    </div>
                                    <div class="modal-body">
                         ...
                         <div class="card-body detail-calon-pelamar no-padding"> <!-- start: step -->
                            <div role="tabpanel">
                                ...
                                <ul class="nav nav-tabs" role="tablist">
                                    ...
                                    <?php if ( $_SESSION['admin_id_recruitment']  == '1' ) : ?>
                                        <li role="presentation" class="pull-right"><a href="#review-hrd" aria-controls="jawaban-soal" role="tab" data-toggle="tab"><div class="icon fa fa-eye"></div> Tinjauan HRD</a></li>
                                    <?php endif; ?>
                                </ul>
                                <!-- Tab panes -->
                                <div class="tab-content">
                                            ...
                                            <div class="tab-pane fade in active">
                                                <div class="col-xs-12 no-padding question-crew">
                                                    <div class="card" style="box-shadow: none;">
                                                        <div class="card-header">
                                                            <div class="card-title">
                                                                <div class="title">BERKAS CALON KARYAWAN</div>
                                                                <div class="detail-btn-edit">
                                                        ...
                                                        <div class="card-body" style="padding-left: 0; padding-right: 0;">
                                                            ...
                                                            $master_berkas_sql = $sdm->query( "SELECT * FROM master_berkas WHERE kategori_pegawai = 'karyawan'" );

                                                            $data_berkas_sql = $sdm->query( "SELECT * FROM kelengkapan_berkas 
                                                                                            LEFT JOIN master_berkas ON kelengkapan_berkas.id_berkas = master_berkas.id_berkas  
                                                                                            LEFT JOIN calon_karyawan ON kelengkapan_berkas.id_calon_karyawan = calon_karyawan.id_calon_karyawan 
                                                                                            WHERE calon_karyawan.id_calon_karyawan = '$key' AND master_berkas.kategori_pegawai = 'karyawan'" 
                                                                                            );
                                                    ...
                                                    <div class="card" style="box-shadow: none;">
                                                        ...
                                                        <div class="card-body" style="padding-left: 0; padding-right: 0;">
                                                            ...
                                                            $data_soal_sql = $sdm->query( "SELECT * FROM soal_soal 
                                                                                            ...
                                                                                            WHERE calon_karyawan.id_calon_karyawan = '$key' AND master_soal.kategori_pegawai = 'karyawan'
                                                                ...
                                                                <div aria-hidden="true" aria-labelledby="myModalPertanyaanPelamarLabel<?php echo $data_soal['id_soal_pelamar'].$no; ?>" role="dialog" tabindex="-1" id="myModalPertanyaanPelamar<?php echo $data_soal['id_soal_pelamar'].$no; ?>" class="modal fade">
                                                                    <div class="modal-dialog modal-lg">
                                                                        <div class="modal-content">
                                                                            ...
                                                                            <div class="modal-body edit-pertanyaan-brow">
                                    ...
                                    <div role="tabpanel" class="tab-pane" id="review-hrd">
                                        <!-- <form class="form-horizontal form-label-left"> -->
                                            <div class="tab-pane fade in active">
                                                <div class="col-xs-12 no-padding question-crew">
                                                    <div class="card" style="box-shadow: none;">
                                                        <div class="card-header">
                                                            <div class="card-title">
                                                                <div class="title">Tinjauan Untuk HRD</div>
                                                            </div>
                                                        </div>
                                                        <div class="card-body" style="padding-left: 0; padding-right: 0;">

                                                            <p class="help-block">#Penempatan posisi</p>
                                                            <div class="form-group">
                                                                <div class="col-lg-2" style="margin-bottom: 15px;">
                                                                    <label>Unit</label>
                                                                </div>
                                                                <div class="col-lg-10" style="margin-bottom: 15px;">
                                                                    <?php
                                                                    // list unit
                                                                    $list_unit_sql = $sdm->query( "SELECT * FROM unit WHERE id_calon_karyawan = '".$data['id_calon_karyawan']."'" );
                                                                    $array_list_unit = '';
                                                                    while ( $data_list_unit = $list_unit_sql->fetch_assoc() ) {
                                                                        $array_list_unit[] = $data_list_unit['id_master_unit'];
                                                                    }

                                                                    // master unit
                                                                    $query = $sdm->query( "SELECT * FROM master_unit WHERE status = '1'" );
                                                                    ...
                                                                    while ( $data_unit = $query->fetch_assoc() ) {
                                                                        ...
                                                                        // $id = $data_unit['id_calon_karyawan'];
                                                                        if ( in_array( $id_unit, $array_list_unit ) ) {
                                                                            $selected = 'selected';
                                                                        } else {
                                                                            $selected = '';
                                                                        }

                                                                        echo "<option value=". $id_unit ." $selected>". $unit ."</option>";
                                                                    }
                                                            ...
                                                            <div class="form-group ">
                                                                ...
                                                                <div class="col-lg-10" style="margin-bottom: 15px;">
                                                                    <?php
                                                                    // list jabatan
                                                                    $list_jabatan_sql = $sdm->query( "SELECT * FROM list_jabatan WHERE id_calon_karyawan = '".$data['id_calon_karyawan']."'" );
                                                                    $array_list_jabatan = '';
                                                                    while ( $data_list_jabatan = $list_jabatan_sql->fetch_assoc() ) {
                                                                        $array_list_jabatan[] = $data_list_jabatan['id_master_jabatan'];
                                                                    }
                                                                    ...
                                                                    while ( $data_jabatan = $query->fetch_assoc() ) {
                                                                        ...
                                                                        $unit = $data_jabatan['jabatan'];

                                                                        $selected = '';

                                                                        // $id = $data_jabatan['id_calon_karyawan'];
                                                                        if ( in_array( $id_jabatan, $array_list_jabatan ) ) {
                                                                            $selected = 'selected';
                                                                        } else {
                                                                            $selected = '';
                                                                        }

                                                                        echo "<option value=". $id_jabatan ." $selected>". $unit ."</option>";
                                                                    }
                                    ...
                                    <div class="tab-pane fade in active">
                                        <div class="col-xs-12 no-padding question-crew">
                                            <div class="card" style="box-shadow: none;">
                                                ...
                                                <div class="card-body" style="padding: 0;">
                                                    ...
                                                    $data_berkas = $sdm->query( "SELECT * FROM master_berkas WHERE kategori_pegawai = 'karyawan'" );
                                        ...
                                        <div class="form-group pull-right">
                                            <div class="col-lg-12">
                                                ...
                                                <button type="submit" name="insert-new-berkas-pelamar-crew" class="btn btn-info">Simpan</button>
                                            </div>
                                        </div>
                                    </div>
                                </form>
